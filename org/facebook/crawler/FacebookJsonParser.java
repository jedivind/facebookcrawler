...
class FacebookJsonParser {
    ...
    private static String trim( String stringToTrim ) {
    ...
    private void crawlUser( JSONObject GroupMemberJSONObject , int IDIndex ) throws IOException, JSONException, SQLException { // Crawl individual user info. Pass list of userIDs to crawl.
        ...
        JSONArray MemberDataFieldNames = GroupMemberDataJSONObject.names();
            ...
            for( int fieldIndex = 0; fieldIndex < MemberDataFieldNames.length(); fieldIndex++ ) {
                ...
                if( MemberDataFieldNames.getString(fieldIndex).equals("location") ) {

                    String locarr[] = JSONObject.getNames(GroupMemberDataJSONObject.getJSONObject("location"));
                ...
                if( MemberDataFieldNames.getString(fieldIndex).equals("hometown") ) {

                    String homearr[] = JSONObject.getNames(GroupMemberDataJSONObject.getJSONObject("hometown"));
                ...
                if( MemberDataFieldNames.getString(fieldIndex).equals("languages") ) {
                    String langs = "";
                ...
                if( MemberDataFieldNames.getString(fieldIndex).equals("education") ) {
                    String education = "";
                ...
                if( MemberDataFieldNames.getString(fieldIndex).equals("work") ) {
                    String work = "";
